...
def registraion_data_filter(registration_json_data):
...
def insert_registarion_details(registration_json_data):
    try:
        # Getting filterd resgistraion details to insert in database
        insert_values, user_email = registraion_data_filter(registration_json_data)
